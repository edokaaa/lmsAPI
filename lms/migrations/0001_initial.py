...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='course',
            name='track',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='lms.track'),
        ),
        migrations.AddField(
            model_name='course',
            name='tutor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('track', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='lms.track')),
            ],
            options={
                'verbose_name': 'user',
                'verbose_name_plural': 'users',
